...
StatusCode Psi3770pi::initialize(){
  ...
  count =0;
    ...
    //To store mc truth.
        ...
        TreeAna->Branch("Ncut0", &Ncut0, "Ncut0/I"); 
        TreeAna->Branch("Ncut1", &Ncut1, "Ncut1/I"); 
        TreeAna->Branch("Ncut2", &Ncut2, "Ncut2/I"); 
        TreeAna->Branch("Ncut3", &Ncut3, "Ncut3/I"); 
        TreeAna->Branch("Ncut4", &Ncut4, "Ncut4/I"); 
        TreeAna->Branch("Ncut5", &Ncut5, "Ncut5/I"); 
        TreeAna->Branch("Ncut6", &Ncut6, "Ncut6/I"); 
        TreeAna->Branch("Ncut7", &Ncut7, "Ncut7/I"); 
...
//**************************************
        ...
        for(int i1 = 0; (i1 < nGamma-2); i1++){
          ...
          /*
          int m = 0;
          double dphi1,dphi2,dphi3,tag1,tag2;
          ...
          for(int j=0; j<N; j++){
            ...
            if(8<=_l[j]&&_l[j]<43){
              ...
              if(tag1<=phi[ihit]&&phi[ihit]<=phi[ihit]){
                count++;
              }
