...
/*
        ...
        TreeAna->Branch("X_4",&X_4,"X_4/D");
        TreeAna->Branch("Y_4",&Y_4,"Y_4/D");
        TreeAna->Branch("Z_4",&Z_4,"Z_4/D");
        TreeAna->Branch("X_5",&X_5,"X_5/D");
        TreeAna->Branch("Y_5",&Y_5,"Y_5/D");
        TreeAna->Branch("Z_5",&Z_5,"Z_5/D");
*/
...
//**************************************
    ...
    double x0,y0,x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,x5,y5,z5;
        ...
        for(int i3 = i2+1; i3 < nGamma; i3++){
          ...
          Hep3Vector *gamma_tag1 = new Hep3Vector();
          Hep3Vector *gamma_tag2 = new Hep3Vector();
          dphi1 = phi1 - phi2;if(dphi1<0){m1=1;dphi1=-dphi1;}
          dphi2 = phi1 - phi3;if(dphi2<0){m2=1;dphi2=-dphi2;}
          dphi3 = phi2 - phi3;if(dphi3<0){m3=1;dphi3=-dphi3;}
          
          if(dphi1<dphi2 && dphi1<dphi3){
            gamma_tag1->setX(emcpos1.x());gamma_tag1->setY(emcpos1.y());gamma_tag1->setZ(emcpos1.z());
            gamma_tag2->setX(emcpos2.x());gamma_tag2->setY(emcpos2.y());gamma_tag2->setZ(emcpos2.z());
            x4= emcpos1.x(); y4=emcpos1.y(); z4 = emcpos1.z();
            x5= emcpos2.x(); y5=emcpos2.y(); z5 = emcpos2.z();
//            X_4 = x4;Y_4 = y4;Z_4 = z4;
//            X_5 = x5;Y_5 = y5;Z_5 = z5;
            if(m1==1){tag1=phi1;tag2=phi2;}else{tag1=phi2;tag2=phi1;}
          }
          if(dphi2<dphi1 && dphi2<dphi3){
            gamma_tag1->setX(emcpos1.x());gamma_tag1->setY(emcpos1.y());gamma_tag1->setZ(emcpos1.z());
            gamma_tag2->setX(emcpos3.x());gamma_tag2->setY(emcpos3.y());gamma_tag2->setZ(emcpos3.z());
            x4= emcpos1.x(); y4=emcpos1.y(); z4 = emcpos1.z();
            x5= emcpos3.x(); y5=emcpos3.y(); z5 = emcpos3.z();
//            X_4 = x4;Y_4 = y4;Z_4 = z4;
//            X_5 = x5;Y_5 = y5;Z_5 = z5;
            if(m2==1){tag1=phi1;tag2=phi3;}else{tag1=phi3;tag2=phi1;}
          }
          if(dphi3<dphi2 && dphi3<dphi1){
            gamma_tag1->setX(emcpos3.x());gamma_tag1->setY(emcpos3.y());gamma_tag1->setZ(emcpos3.z());
            gamma_tag2->setX(emcpos2.x());gamma_tag2->setY(emcpos2.y());gamma_tag2->setZ(emcpos2.z());
            x4= emcpos3.x(); y4=emcpos3.y(); z4 = emcpos3.z();
            x5= emcpos2.x(); y5=emcpos2.y(); z5 = emcpos2.z();
//            X_4 = x4;Y_4 = y4;Z_4 = z4;
//            X_5 = x5;Y_5 = y5;Z_5 = z5;
            if(m3==1){tag1=phi2;tag2=phi3;}else{tag1=phi3;tag2=phi2;}
          }
...
/*
              ...
              cout<<"  x5= "<<x5<<"; y5="<<y5<<";z5= "<<z5<<";"<<endl;

              cout<<" x1= "<<eastP.x()<<"; y1="<<eastP.y()<<";z1="<<eastP.z()<<";"<<endl;
              cout<<" x2= "<<westP.x()<<"; y2="<<westP.y()<<";z2="<<westP.z()<<";"<<endl;
*/              
...
/*              
              Hep3Vector *g1 = new Hep3Vector(r1*gamma_tag1->x(),r1*gamma_tag1->y(),r1*gamma_tag1->z());
              Hep3Vector *g2 = new Hep3Vector(r2*gamma_tag2->x(),r2*gamma_tag2->y(),r2*gamma_tag2->z());

              Hep3Vector g3 = *g1 + *g2;

              double r_ = 1.0/sqrt(g3.mag2());

              Hep3Vector *g4 = new Hep3Vector(g3.getX()*r_,g3.getY()*r_,g3.getZ()*r_);
              
              double l = g4->dot(*g1)*sqrt(x4*x4+y4*y4+z4*z4);
              double r = TMath::Sin(TMath::ACos(g1->dot(*g4))+0.06)*sqrt(x4*x4+y4*y4+z4*z4);
...
//              int shape_ = Psi3770pi::shape(x0,y0,x1,y1,z1,x2,y2,z2,x4,y4,z4,l1,r1);
              ...
              if(  (tag1m<=phi[j]&&phi[j]<=tag1p) ||  (tag2m<=phi[j]&&phi[j]<=tag2p) ) {
                ...
                //cout<<" above taged!!!-----------------------------------------------"<<endl;
                //if(shape_==1){cout<<"with cone!!!!!!"<<endl;}
                //else{mark++;}
          ...
          if(count_phi2!=0 || count_cone!=0){
            mark++;
/*        
          cout<<"count_cone "<<count_cone<<endl;
          cout<<"count_phi "<<count_phi<<endl;
          cout<<"mark "<<mark<<endl;
*/
          }
//          cout<<"/////////////////////////////"<<endl;
          ...
          mass_2 = gamma.M();
          //sqrt(gamma.E()*gamma.E()-gamma.Pz()*gamma.Pz()-gamma.Py()*gamma.Py()-gamma.Px()*gamma.Px());
          mass_t = gamma_t.M();
          //sqrt(gamma_t.E()*gamma_t.E()-gamma_t.Pz()*gamma_t.Pz()-gamma_t.Py()*gamma_t.Py()-gamma_t.Px()*gamma_t.Px());
