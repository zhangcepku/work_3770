...
TH1F *chi2(TFile *f1,int op,double cut, int cut2){
...
*/
    ...
    t1->SetBranchAddress("count_phi",&count_phi);
//
...
//            cout<<"x4="<<x4<<";y4= "<<y4<<";z4= "<<z4<<";x5= "<<x5<<";y5= "<<y5<<";z5= "<<z5<<";"<<endl;

            x0 = (x1+x2)/2;
            y0 = (y1+y2)/2;
            int result1 = shape0823(x0,y0,x1,y1,z1,x2,y2,z2,x4,y4,z4,l1,r1);
            
            if(result1 == 1)m++;
            else {
                int result2 = shape0823(x0,y0,x1,y1,z1,x2,y2,z2,x5,y5,z5,l2,r2);
                if(result2 == 1)m++;
            }
...
//                cout<<"//////////////////////////////"<<endl;
        ...
        if (Chisq1<=50 && mass2>=0.1 && mass2 <=0.16){
            ...
            //if(the_decay<1.0){
            if (the_decay<cut && count_cone2<=cut2){
            //if (the_decay<cut){
